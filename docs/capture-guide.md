...
- Keep textured surfaces in view; blank walls and reflections are difficult.

Start with the **Low quality** preset to check registration, then use **High
quality** after the capture succeeds. If registration is low, recapture with
more overlap and parallax—longer training cannot repair missing camera poses.
